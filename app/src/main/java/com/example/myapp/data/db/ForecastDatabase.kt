...
abstract class ForecastDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile private var instance: ForecastDatabase? = null //all of the threats have access to that property
        private val LOCK = Any()       // (make sure) no two threats are doing the same thing
